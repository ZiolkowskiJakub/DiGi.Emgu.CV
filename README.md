...
**DiGi.Emgu.CV** is a C# engineering and architectural software library suite designed for BIM and CAD integrations (such as Revit, RhinoCommon, Grasshopper, and Dynamo BIM).
...
* **[DiGi.Emgu.CV](DiGi.Emgu.CV)** (Path: `DiGi.Emgu.CV\DiGi.Emgu.CV`)
